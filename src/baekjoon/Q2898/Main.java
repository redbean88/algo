...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        StringTokenizer line0 = new StringTokenizer(br.readLine());
        int data = Integer.parseInt(line0.nextToken());
        int[] numbers = new int[data];
        int target = Integer.parseInt(line0.nextToken());

        StringTokenizer line1 = new StringTokenizer(br.readLine());
        for (int i = 0; i < data; i++) {
            numbers[i] = Integer.parseInt(line1.nextToken());
        }

        int result = new Main().solution(numbers, target);
